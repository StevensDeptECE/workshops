...
execute_process(
  COMMAND "/usr/bin/git" show-ref d141cdbeb0fb422a3fb7173b285fd38e0d1772dc
  WORKING_DIRECTORY "/home/dkruger/git/course/workshops/opengl/src/01shaders/include/fmt"
...
if("${show_ref_output}" MATCHES "refs/remotes/d141cdbeb0fb422a3fb7173b285fd38e0d1772dc")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "d141cdbeb0fb422a3fb7173b285fd38e0d1772dc")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "d141cdbeb0fb422a3fb7173b285fd38e0d1772dc")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 d141cdbeb0fb422a3fb7173b285fd38e0d1772dc
  WORKING_DIRECTORY "/home/dkruger/git/course/workshops/opengl/src/01shaders/include/fmt"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/dkruger/git/course/workshops/opengl/src/01shaders/include/fmt/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/dkruger/git/course/workshops/opengl/src/01shaders/include/fmt/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
